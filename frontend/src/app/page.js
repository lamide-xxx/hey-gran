    ...
    <>
      ...
      <div className="flex items-center bg-background-light dark:bg-background-dark p-6 justify-between sticky top-0 z-10 w-full max-w-md mx-auto">
        <div className="flex size-12 shrink-0 items-center">
          <div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10 border-2 border-primary" aria-label="Profile picture of a smiling woman named Julia" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuC_79dWn4STSPMAvreEtZWFqsRePCJGvZD0KoVmHjH2WQCgYpT8l7HVGCcg19enMGQqLKEJrNiItyl7d-soof-6KqZtX_P5f2I5DMHviE8WG9ZKAxQY5oLQdUysPhQVrmrXLBb-8SEvkeyCA8kD7tIJ3NIiXhEVlkPFKDNkfUQtfXDmy3WeITSSiNOnJOkA3qF66ebNWfoEl0eCnHyZZIQvjA4dKwIYGUNvtjZuFsnfpEML4oiIL0Z4EK8l7iLYrxhBgLlUC3tNsvs")' }}></div>
        </div>
        ...
        <section>
          ...
          <div className={`flex flex-col overflow-hidden rounded-xl shadow-sm bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 transition-all duration-500 ${isNewCall ? "ring-2 ring-primary scale-[1.01]" : ""}`}>
            {latestCall?.name === "Uncle Arthur" ? (
              <div className="w-full bg-center bg-no-repeat aspect-[16/9] bg-cover" aria-label="Arthur smiling" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuBjyJfvwQGcu1ey9i9yuDB_p_vQlkIQgCgbPJT4bVJNmrQLsuOKjS3YW0Y_TUao2FQRzc0G3Nsc1AuxbsY_ouOKRqvoPFZyihgI1mXNlnfuy8g3ODaufbudGL7eUgKd-1SBYj1Ujn7E9NkbFfUnoRcP6yPUyJVmBujmB-QJ_Yq5ToBbLHe6V-AdZLNERfCH8OBqT35-jbpM8mFFl8BV5x0geLo6sc1IORvanbbqEmE3ghhVRJ-8vYJp8evXqcu_eSaVFsuyT6z54so")' }}></div>
            ) : (
              <div className="w-full bg-center bg-no-repeat aspect-[16/9] bg-cover" aria-label="Elderly woman smiling in her garden with flowers" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuB6Jv_YfedJms8umc8rAKOHzRGU7YNQmVei4rl22MYV6YBv5gh4854VpXPfMn8afiBQINq8N_DmRX7NRvQwkpExeN60eWMiTUv1UWF2AjyAI9Qy-mJX6O6Iqt0E4Cvy8y6rO-s88-lNzs-YFE7HmWCwY_X7lyjhmZb0zls38Atw_wRgIEU0IVdNIGH-rtXNp9OKZvILQIlICfmT9PTALevbGSK780Rn0LMeqJmr6EWNqA4XIOWp-m22JAGoBdolii5QRbtzxw7gQmU")' }}></div>
            )}
